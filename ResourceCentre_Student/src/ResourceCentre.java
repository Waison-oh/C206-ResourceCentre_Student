...
public class ResourceCentre {
	...
	//================================= Option 3 Loan =================================
	public static boolean doLoanCamcorder(ArrayList<Camcorder> camcorderList, String tag, String dueDate) { // will be done by qiaoling :DD
	...
	public static boolean doLoanChromebook(ArrayList<Chromebook> chromebookList, String tag, String dueDate) {// will be done by qiaoling :DD
		boolean isLoaned = false;
	...
	public static void loanChromebook(ArrayList<Chromebook> chromebookList) {// will be done by qiaoling :DD
		// write your code here
		ResourceCentre.viewAllChromebook(chromebookList);
		String tag = Helper.readString("Enter asset tag > ");
		String due = Helper.readString("Enter due date > ");
